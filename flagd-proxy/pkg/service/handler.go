...
import (
	...
	syncv12 "buf.build/gen/go/open-feature-forking/flagd/protocolbuffers/go/flagd/sync/v1"
	syncv1 "buf.build/gen/go/open-feature-forking/flagd/protocolbuffers/go/sync/v1"
