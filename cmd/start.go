...
func init() {
	...
	flags.StringP(socketPathFlagName, "d", "", "Flagd socket path. With grpc the service will become available on this address. With http(s) the grpc-gateway proxy will use this address internally.")
