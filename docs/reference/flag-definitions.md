...
| `lower` / `upper`                  | Transform a string to ASCII lower/upper case        | string                                       | Logic: `#!json { "lower" : [ "User@Example.com" ] }`<br>Result: `"user@example.com"`<br><br>Logic: `#!json { "upper" : [ "us" ] }`<br>Result: `"US"`<br>Additional documentation can be found [here](./custom-operations/string-casing-operation.md).                                              |
