...
```
  ...
  -s, --sources string                      JSON representation of an array of ProviderConfig objects. This object contains 2 required fields, uri (string) and provider (string). Documentation for this object can be found here: https://github.com/open-feature/flagd/blob/main/docs/configuration/configuration.md#sync-provider-customisation
