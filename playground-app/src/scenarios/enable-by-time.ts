...
export const enableByTime: Scenario = {
  description: [
    ...
    "This flag has a targeting rule defined that enables the flag for users when the current time is greater or equal to the scheduled release.",
    "This feature schedule for release 5 seconds after the scenario is loaded.",
  ].join(" "),
  flagDefinition: () =>
