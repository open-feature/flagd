...
require (
	buf.build/gen/go/james-milligan/flagd-2/bufbuild/connect-go v1.4.0-20221219161535-51d0a2e33a6f.1
	buf.build/gen/go/james-milligan/flagd-2/grpc/go v1.2.0-20221219161535-51d0a2e33a6f.4
	buf.build/gen/go/james-milligan/flagd-2/protocolbuffers/go v1.28.1-20221219161535-51d0a2e33a6f.4
